...
namespace HistorianSyncTool.UI
{
    ...
    public static class AppTheme
    {
        ...
        public static readonly Color Teal         = Color.FromArgb(26,  188, 156);  // #1ABC9C (Info / catchy CTA)
        public static readonly Color TealHover    = Color.FromArgb(22,  160, 133);  // #16A085
        public static readonly Color RowAlt       = Color.FromArgb(248, 249, 253);  // alternate grid row
        public static readonly Color RowAltWarm   = Color.FromArgb(253, 249, 245);  // warm alternate row (for secondary-server rows)
