...
namespace HistorianSyncTool.UI
{
    ...
    public static class Loc
    {
            ...
            new Dictionary<string, string[]>(StringComparer.Ordinal)
        {
            ...
            { "ov.summaryMissing",    new[] { "{0} point(s) · {1} need attention ({2} not on both servers) · checked in {3:F1} s",
                                              "{0} Messstelle(n) · {1} auffällig ({2} nicht auf beiden Servern) · geprüft in {3:F1} s" } },
