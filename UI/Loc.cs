...
namespace HistorianSyncTool.UI
{
    ...
    public static class Loc
    {
            ...
            new Dictionary<string, string[]>(StringComparer.Ordinal)
        {
            ...
            { "cred.intro",           new[] { "Enter the user name and password for the Historian servers. Both servers use this login unless you tick the box below.",
                                              "Benutzername und Kennwort für die Historian-Server eingeben. Beide Server verwenden diese Anmeldung, sofern das Kästchen unten nicht angehakt ist." } },
            ...
            { "cred.separate",        new[] { "The mirror uses a different login",
                                              "Der Spiegel verwendet eine andere Anmeldung" } },
            { "cred.mirrorHeader",    new[] { "Mirror server",                           "Spiegelserver" } },
